...
POST http://localhost:8080/soap/hello

header Content-Type: text/xml;charset=UTF-8
Body 
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
    <soap:Body>
        <ns2:hello xmlns:ns2="http://itveen.dk/">
            <arg0>World</arg0>
        </ns2:hello>
    </soap:Body>
</soap:Envelope>
...
You can then execute your native executable with: `./build/cfx-service-1.0.0-SNAPSHOT-runner`
